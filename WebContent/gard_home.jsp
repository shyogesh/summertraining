...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Gard Home</h1>
                </div>
              <%
				...
				<div class="panel-body">
					<div id="dataTables-example_wrapper"
						...
						<tr>							
							...
							<td><%=userList.get(i).getBranch()%></td>
							...
							<td>
							<%=userList.get(i).getStatus().equals("allow")?"Allowed":"Rejected"%>
							By <%=userList.get(i).getApprovedBy().getUsername()%>
							</td>
